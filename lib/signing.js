...
function signApkFile(apkFile, signingKeyFile, alias, keyStorePassword, keyPassword, customArgs) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (customArgs) {
            ...
            splitArgs.forEach(function (p1, p2, p3) {
                args.push(p1);
            });
        }
        args.push(apkFile);
...
function signAabFile(aabFile, signingKeyFile, alias, keyStorePassword, keyPassword, customArgs) {
    return __awaiter(this, void 0, void 0, function* () {
