...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const customArgs = core.getInput("customArgs");
            ...
            if (releaseFiles !== undefined && releaseFiles.length !== 0) {
                ...
                for (let releaseFile of releaseFiles) {
                    ...
                    if (releaseFile.name.endsWith('.apk')) {
                        signedReleaseFile = yield (0, signing_1.signApkFile)(releaseFilePath, signingKey, alias, keyStorePassword, keyPassword, customArgs);
                    }
                    else if (releaseFile.name.endsWith('.aab')) {
                        signedReleaseFile = yield (0, signing_1.signAabFile)(releaseFilePath, signingKey, alias, keyStorePassword, keyPassword, customArgs);
                    }
                    else {
                ...
                fs_1.default.unlinkSync(signingKey);
